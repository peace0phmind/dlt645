...
const (
	TotalActiveEnergy             = 0x00000000 // 组合有功总电能
	PositiveTotalActiveEnergy     = 0x00010000 // 正向有功总电能
	NegativeTotalActiveEnergy     = 0x00020000 // 反向有功总电能
	TotalReactiveEnergy1          = 0x00030000 // 组合无功1总电能
	TotalReactiveEnergy2          = 0x00040000 // 组合无功2总电能
	FirstQuadrantReactiveEnergy   = 0x00050000 // 第一象限无功电能
	SecondQuadrantReactiveEnergy  = 0x00060000 // 第二象限无功电能
	ThirdQuadrantReactiveEnergy   = 0x00070000 // 第三象限无功电能
	FourthQuadrantReactiveEnergy  = 0x00080000 // 第四象限无功电能
	PositiveTotalApparentEnergy   = 0x00090000 // 正向视在总电能
	NegativeTotalApparentEnergy   = 0x000A0000 // 反向视在总电能
	AssociatedTotalElectricEnergy = 0x00800000 // 关联总电能

	ABLineVoltage                 = 0x020C0100 // AB线电压
	BCLineVoltage                 = 0x020C0200 // BC线电压
	CALineVoltage                 = 0x020C0300 // CA线电压
	Frequency                     = 0x02800002 // 频率
	DateTime                      = 0x04000101 // 年月日星期
	Time                          = 0x04000102 // 时分秒
	LastDailyFreezeTime           = 0x05060001 // 上一次日冻结时间
	LastDailyPositiveActiveEnergy = 0x05060101 // 上一次日冻结正向有功电能

	TotalOverCurrentCount       = 0x30C0000 // 过流总次数，总时间
	LastPhaseAOverCurrentRecord = 0x30C0101 // 上一次A相过流记录

	TotalMeterResetCount = 0x3300100 // 电表清零总次数
	MeterResetRecord     = 0x3300101 // 电表清零记录

	AssetManagementCode = 0x4000403 // 资产管理编码

	SignalStrength = 0x4000701 // 信号强度

	VersionNumber = 0x4000702 // 版本号

	MasterAPIKey = 0x7000001 // master_api_key
	DeviceID     = 0x7000002 // device_id
)
